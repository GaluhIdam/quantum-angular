...
export class UtilityDetailMatterComponent extends BaseController {
  ...
  /** Write off form */
  writeOffForm: FormControl = new FormControl({
    label: 'All',
    value: 'All',
  });
  optionWriteOff: {
  ...
  /** Billing Number */
  billingNumberSearch: FormControl = new FormControl();
  ...
  /** Write Off Selection */
  selectionWriteOff(event: { name: string; value: any }[]): void {
    // this.selectedWriteOff = event;
    // if (event.length > 0) {
    //   this.enableFilter('Matter', true);
    // } else {
    //   this.enableFilter('Matter', false);
  ...
  selectionBillingNumber(event: { name: string; value: any }[]): void {
    // this.selectedBillingNumber = event;
    // if (event.length > 0) {
    //   this.enableFilter('Matter', true);
    // } else {
    //   this.enableFilter('Matter', false);
